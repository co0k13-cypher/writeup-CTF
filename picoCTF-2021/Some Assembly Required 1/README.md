...
Ta có một form **Enter flag** nhưng mà khi nhập vào thì chỉ có một thông báo *incorrect* để ý thấy khi nhấn submit thì sẽ có một hàm *onButtonPress()* được gọi và hàm này thì nằm trong file  *G82XCw5CX3.js*

Thử bật devtool > sources > G82XCw5CX3.js

```
onst _0x402c = ['value', '2wfTpTR', 'instantiate', '275341bEPcme', 'innerHTML', '1195047NznhZg', '1qfevql', 'input', '1699808QuoWhA', 'Correct!', 'check_flag', 'Incorrect!', './JIFxzHyW8W', '23SMpAuA', '802698XOMSrr', 'charCodeAt', '474547vVoGDO', 'getElementById', 'instance', 'copy_char', '43591XxcWUl', '504454llVtzW', 'arrayBuffer', '2NIQmVj', 'result'];
...
Đây là một định dạng file [WebAssembly](https://developer.mozilla.org/en-US/docs/WebAssembly) . Qua tìm hiểu thì trên các trình duyệt như firefox và chorme có một tool debug là wasm , bạn có thể truy cập vào đó và lấy cờ .
